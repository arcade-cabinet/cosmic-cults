...
export const HexMesh: React.FC<HexMeshProps> = ({
  ...
  const meshData = useMemo(() => {
    ...
    if (!baseColor) {
      switch (type) {
        case 'plains': baseColor = Color3.Green(); break;
        case 'mountain': baseColor = Color3.Gray(); finalHeight = height * 3; break;
        case 'water': baseColor = Color3.Blue(); finalHeight = height * 0.5; break;
        case 'void': baseColor = Color3.Purple(); break;
        default: baseColor = Color3.White();
      }
    }
