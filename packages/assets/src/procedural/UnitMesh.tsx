import { Color3, type Mesh, Vector3 } from '@babylonjs/core';
...
export const UnitMesh: React.FC<UnitMeshProps> = ({
  ...
  useEffect(() => {
    ...
    scene.registerBeforeRender(animateUnit);
    return () => {
      scene.unregisterBeforeRender(animateUnit);
    };
  }, [scene, faction]);
      ...
      case 'flesh-weavers': // Spiky, aggressive
        return (
          <>
            ...
            <cylinder
              name="arm_l"
              options={{ height: 1, diameterTop: 0, diameterBottom: 0.2 }}
      ...
      case 'star-children': // Rounded, organic, aquatic
        return (
          <>
            ...
            <torus
              name="fins"
              options={{ diameter: 1.2, thickness: 0.1 }}
      ...
      default:
        return (
          <>
            ...
            <sphere name="field" options={{ diameter: 1.5, segments: 8 }}>
              <standardMaterial
                name="mat_field"
                wireframe={true}
  ...
  return (
    ...
    >
      ...
      {selected && (
        <torus
          name="selection_ring"
          options={{ diameter: 1.5, thickness: 0.05 }}
